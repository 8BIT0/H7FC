...
#define __STM32H7xx_CMSIS_DEVICE_VERSION ((__STM32H7xx_CMSIS_DEVICE_VERSION_MAIN << 24) | (__STM32H7xx_CMSIS_DEVICE_VERSION_SUB1 << 16) | (__STM32H7xx_CMSIS_DEVICE_VERSION_SUB2 << 8) | (__STM32H7xx_CMSIS_DEVICE_VERSION_RC))
