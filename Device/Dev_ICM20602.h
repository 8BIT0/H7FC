...
typedef struct
{
    ...
    bool (*config)(DevICM20602Obj_TypeDef *Obj, ICM20602_SampleRate_List rate, ICM20602_GyrTrip_List GyrTrip, ICM20602_AccTrip_List AccTrip);
    ...
    IMU_Error_TypeDef (*get_error)(DevICM20602Obj_TypeDef *Obj);
