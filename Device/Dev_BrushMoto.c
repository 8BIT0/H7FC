...
__attribute__((weak)) bool Brush_Port_Init(void *obj, uint32_t prescaler, uint32_t auto_reload, void *time_ins, uint32_t time_ch, void *pin){return false;}
...
static bool DevBrushMoto_Init(DevBrushMotoObj_TypeDef *obj, void *timer_ins, uint32_t ch, void *pin)
{
    ...
    auto_reload = BRUSH_TMR_PERIOD;

    return Brush_Port_Init(obj, prescaler, auto_reload, timer_ins, ch, pin);
}
