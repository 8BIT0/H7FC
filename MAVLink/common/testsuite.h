...
static void mavlink_test_fileadapter(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_fileadapter_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fileadapter_pack(system_id, component_id, &msg , packet1.FrameType , packet1.Version , packet1.DataType , packet1.total_size , packet1.pack_size , packet1.segment_size , packet1.pack_id , packet1.pack_segment_id , packet1.Payload );
    mavlink_msg_fileadapter_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fileadapter_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.FrameType , packet1.Version , packet1.DataType , packet1.total_size , packet1.pack_size , packet1.segment_size , packet1.pack_id , packet1.pack_segment_id , packet1.Payload );
    mavlink_msg_fileadapter_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_fileadapter_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fileadapter_send(MAVLINK_COMM_1 , packet1.FrameType , packet1.Version , packet1.DataType , packet1.total_size , packet1.pack_size , packet1.segment_size , packet1.pack_id , packet1.pack_segment_id , packet1.Payload );
    mavlink_msg_fileadapter_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
