...
static void mavlink_test_para_operation(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Para_Operation >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_para_operation_t packet_in = {
        17235,17339,17443,151
    };
    mavlink_para_operation_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.Sys_ID = packet_in.Sys_ID;
        packet1.Comp_ID = packet_in.Comp_ID;
        packet1.type_index = packet_in.type_index;
        packet1.opr_type = packet_in.opr_type;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Para_Operation_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Para_Operation_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_operation_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_para_operation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_operation_pack(system_id, component_id, &msg , packet1.Sys_ID , packet1.Comp_ID , packet1.type_index , packet1.opr_type );
    mavlink_msg_para_operation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_operation_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Sys_ID , packet1.Comp_ID , packet1.type_index , packet1.opr_type );
    mavlink_msg_para_operation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_para_operation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_operation_send(MAVLINK_COMM_1 , packet1.Sys_ID , packet1.Comp_ID , packet1.type_index , packet1.opr_type );
    mavlink_msg_para_operation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("Para_Operation") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_Para_Operation) != NULL);
#endif
}

static void mavlink_test_para_gyrox_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Para_GyroX_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_para_gyrox_pid_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_para_gyrox_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.gain_p = packet_in.gain_p;
        packet1.p_diff_max = packet_in.p_diff_max;
        packet1.p_diff_min = packet_in.p_diff_min;
        packet1.gain_I = packet_in.gain_I;
        packet1.I_Max = packet_in.I_Max;
        packet1.I_Min = packet_in.I_Min;
        packet1.gain_D = packet_in.gain_D;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Para_GyroX_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Para_GyroX_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyrox_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_para_gyrox_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyrox_pid_pack(system_id, component_id, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_gyrox_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyrox_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_gyrox_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_para_gyrox_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyrox_pid_send(MAVLINK_COMM_1 , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_gyrox_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("Para_GyroX_PID") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_Para_GyroX_PID) != NULL);
#endif
}

static void mavlink_test_para_gyroy_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Para_GyroY_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_para_gyroy_pid_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_para_gyroy_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.gain_p = packet_in.gain_p;
        packet1.p_diff_max = packet_in.p_diff_max;
        packet1.p_diff_min = packet_in.p_diff_min;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Para_GyroY_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Para_GyroY_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyroy_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_para_gyroy_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyroy_pid_pack(system_id, component_id, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_gyroy_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyroy_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_gyroy_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_para_gyroy_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyroy_pid_send(MAVLINK_COMM_1 , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_gyroy_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("Para_GyroY_PID") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_Para_GyroY_PID) != NULL);
#endif
}

static void mavlink_test_para_gyroz_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Para_GyroZ_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_para_gyroz_pid_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_para_gyroz_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.gain_p = packet_in.gain_p;
        packet1.p_diff_max = packet_in.p_diff_max;
        packet1.p_diff_min = packet_in.p_diff_min;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Para_GyroZ_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Para_GyroZ_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyroz_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_para_gyroz_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyroz_pid_pack(system_id, component_id, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_gyroz_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyroz_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_gyroz_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_para_gyroz_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_gyroz_pid_send(MAVLINK_COMM_1 , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_gyroz_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("Para_GyroZ_PID") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_Para_GyroZ_PID) != NULL);
#endif
}

static void mavlink_test_para_roll_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Para_Roll_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_para_roll_pid_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_para_roll_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.gain_p = packet_in.gain_p;
        packet1.p_diff_max = packet_in.p_diff_max;
        packet1.p_diff_min = packet_in.p_diff_min;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Para_Roll_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Para_Roll_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_roll_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_para_roll_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_roll_pid_pack(system_id, component_id, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_roll_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_roll_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_roll_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_para_roll_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_roll_pid_send(MAVLINK_COMM_1 , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_roll_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("Para_Roll_PID") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_Para_Roll_PID) != NULL);
#endif
}

static void mavlink_test_para_pitch_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Para_Pitch_PID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_para_pitch_pid_t packet_in = {
        17.0,45.0,73.0,101.0,129.0,157.0,185.0
    };
    mavlink_para_pitch_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.gain_p = packet_in.gain_p;
        packet1.p_diff_max = packet_in.p_diff_max;
        packet1.p_diff_min = packet_in.p_diff_min;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Para_Pitch_PID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Para_Pitch_PID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_pitch_pid_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_para_pitch_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_pitch_pid_pack(system_id, component_id, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_pitch_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_pitch_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_pitch_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_para_pitch_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_para_pitch_pid_send(MAVLINK_COMM_1 , packet1.gain_p , packet1.p_diff_max , packet1.p_diff_min , packet1.gain_I , packet1.I_Max , packet1.I_Min , packet1.gain_D );
    mavlink_msg_para_pitch_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("Para_Pitch_PID") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_Para_Pitch_PID) != NULL);
#endif
}

static void mavlink_test_fileadapter(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_FileAdapter >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_fileadapter_t packet_in = {
        17235,17339,17,84,151
    };
    mavlink_fileadapter_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.total_size = packet_in.total_size;
        packet1.pack_num = packet_in.pack_num;
        packet1.FrameType = packet_in.FrameType;
        packet1.Version = packet_in.Version;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_FileAdapter_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_FileAdapter_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fileadapter_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_fileadapter_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fileadapter_pack(system_id, component_id, &msg , packet1.FrameType , packet1.Version , packet1.DataType , packet1.total_size , packet1.pack_num );
    mavlink_msg_fileadapter_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fileadapter_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.FrameType , packet1.Version , packet1.DataType , packet1.total_size , packet1.pack_num );
    mavlink_msg_fileadapter_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_fileadapter_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_fileadapter_send(MAVLINK_COMM_1 , packet1.FrameType , packet1.Version , packet1.DataType , packet1.total_size , packet1.pack_num );
    mavlink_msg_fileadapter_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("FileAdapter") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_FileAdapter) != NULL);
#endif
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_para_operation(system_id, component_id, last_msg);
    mavlink_test_para_gyrox_pid(system_id, component_id, last_msg);
    mavlink_test_para_gyroy_pid(system_id, component_id, last_msg);
    mavlink_test_para_gyroz_pid(system_id, component_id, last_msg);
    mavlink_test_para_roll_pid(system_id, component_id, last_msg);
    mavlink_test_para_pitch_pid(system_id, component_id, last_msg);
    mavlink_test_fileadapter(system_id, component_id, last_msg);
}
